...
I am excited to announce the release of a new preprint 'Robust Graph-Based Semi-Supervised Learning via p-Conductances'. This comes as a sequel of sorts to our earlier paper on effective resistance for probability measures on graphs, and is the result of work by a host of collaborators: Chester Holtz, Zhengchao Wan, Gal Mishne, Alexander Cloninger. [The paper can be found on ArXiv](https://arxiv.org/abs/2502.08873).
